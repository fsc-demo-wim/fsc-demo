...
var rootCmd = &cobra.Command{
	Use:   "fsc-controller",
	Short: "fsc-controller discovers server2switch topology for SRIOV/IPVLAN/MACVLAN connectiivty in a k8s cluster and indicates the workload provisioning to the switch controller",
